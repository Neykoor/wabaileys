...
export const makeMessagesSocket = (config) => {
    ...
    const profilePicCache = new NodeCache({
    ...
    const SESSION_FETCH_CHUNK_SIZE = 50;
    ...
    const assertSessions = async (jids, force) => {
        ...
        if (jidsRequiringFetch.length) {
            ...
            const chunks = chunkArray(wireJids, SESSION_FETCH_CHUNK_SIZE);
    ...
    return {
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            const userLid = authState.creds.me?.lid;
            if (Array.isArray(jid)) {
                ...
                const fullMsg = await generateWAMessage(jid, content, {
                    ...
                    getProfilePicUrl: async (jid) => {
                        ...
                        const url = await sock.profilePictureUrl(jid).catch(() => undefined);
