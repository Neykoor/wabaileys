...
export function makeLibSignalRepository(auth, logger, pnToLIDFunc) {
    ...
    const repository = {
        ...
        async migrateSession(fromJid, toJid) {
            // Session migration loads device list from local storage and copies Signal sessions from PN to LID addressing.
            // A USync-based approach would fetch the device list live but adds network latency and is unnecessary
            // since device-list entries are already stored during normal operation.
